...
MODELS_DIR = "/llamas_8b" # create volume to store it in

DEFAULT_NAME = "meta-llama/Llama-3.1-8B-Instruct"
# DEFAULT_REVISION = "8c22764a7e3675c50d4c7c9a4edb474456022b16"

volume = modal.Volume.from_name("llamas_8b", create_if_missing=True)
